/*
 * arch/mips/brcmstb/brcm97400b0/board.c
 *
...
#define STRAP_DDR_CONFIGURATION_MASK  	0x00006000
...
board_init_once(void)
{
	 ...
	 * Bit 14: indicates the configuration of DDR1/DDR2 (both set the same)
	 * Bit 15: indicates the configuration of DDR2
	 */
