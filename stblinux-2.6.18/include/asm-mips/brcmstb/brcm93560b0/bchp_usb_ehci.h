 ...
 *
 *
 * Date:           Generated on         Tue Mar  7 11:09:44 2006
 ...
 * Revision History:
 *
 * $brcm_Log: /magnum/basemodules/chp/3560/rdb/b0/bchp_usb_ehci.h $
 * 
 ...
 ***************************************************************************/
#define BCHP_USB_EHCI_HCCAPBASE                  0x004c0300 /* EHCI Capability Register */
#define BCHP_USB_EHCI_HCSPARAMS                  0x004c0304 /* EHCI Structural Parameter */
#define BCHP_USB_EHCI_HCCPARAMS                  0x004c0308 /* EHCI Capability Parameter */
#define BCHP_USB_EHCI_USBCMD                     0x004c0310 /* USB Command Register */
#define BCHP_USB_EHCI_USBSTS                     0x004c0314 /* USB Status  Register */
#define BCHP_USB_EHCI_USBINTR                    0x004c0318 /* USB Interrupt Enable Register */
#define BCHP_USB_EHCI_FRINDEX                    0x004c031c /* USB Frame Index Register */
#define BCHP_USB_EHCI_PERIODICLISTBASE           0x004c0324 /* Periodic Frame List Base Address Register */
#define BCHP_USB_EHCI_ASYNCLISTADDR              0x004c0328 /* Asynchronous List Address */
#define BCHP_USB_EHCI_CONFIGFLAG                 0x004c0350 /* Configured Flag Register */
#define BCHP_USB_EHCI_PORTSC_0                   0x004c0354 /* Port Status/Control Register for Port 0 */
#define BCHP_USB_EHCI_INSNREG00                  0x004c0390 /* Microframe Base Value Register */
#define BCHP_USB_EHCI_INSNREG01                  0x004c0394 /* Packet Buffer OUT/IN Threshold Register */
#define BCHP_USB_EHCI_INSNREG02                  0x004c0398 /* Packet Buffer Depth Register */
#define BCHP_USB_EHCI_INSNREG03                  0x004c039c /* Break Memory Transfer Register */
#define BCHP_USB_EHCI_INSNREG04                  0x004c03a0 /* Debug Register */
#define BCHP_USB_EHCI_INSNREG05                  0x004c03a4 /* UTMI Control and Status Register */
