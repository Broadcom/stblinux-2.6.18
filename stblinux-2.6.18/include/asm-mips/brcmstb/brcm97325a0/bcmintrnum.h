...
#define BCM_LINUX_UARTA_IRQ		(1+32+32+32)
#define BCM_LINUX_UARTB_IRQ		(BCM_LINUX_UARTA_IRQ+1)
#define BCM_LINUX_UARTC_IRQ		(BCM_LINUX_UARTA_IRQ+2)

#ifdef	CONFIG_MIPS_MT_SMTC		
#define BCM_LINUX_CPU_0			(BCM_LINUX_UARTA_IRQ+3)
#define BCM_LINUX_CPU_1			(BCM_LINUX_UARTA_IRQ+4)
#define BCM_LINUX_CPU_2			(BCM_LINUX_UARTA_IRQ+5)
#define BCM_LINUX_CPU_3			(BCM_LINUX_UARTA_IRQ+6)
#define BCM_LINUX_CPU_4			(BCM_LINUX_UARTA_IRQ+7)
#define BCM_LINUX_CPU_5			(BCM_LINUX_UARTA_IRQ+8)
#define BCM_LINUX_CPU_6			(BCM_LINUX_UARTA_IRQ+9)
#define BCM_LINUX_CPU_7			(BCM_LINUX_UARTA_IRQ+10)
...
#define BCM_GR_BRIDGE_ERROR_IRQ	(BCM_LINUX_UARTA_IRQ+10)
#else	// CONFIG_MIPS_MT_SMTC
#define BCM_LINUX_SYSTIMER_IRQ		(BCM_LINUX_UARTA_IRQ+3)
#define BCM_LINUX_SYSTIMER_1_IRQ 	(BCM_LINUX_UARTA_IRQ+4)

#define POD_DET_IRQ_NUM  		(BCM_LINUX_UARTA_IRQ+5)

#define BCM_LINUX_IPC_0_IRQ		(BCM_LINUX_UARTA_IRQ+6)
#define BCM_LINUX_IPC_1_IRQ		(BCM_LINUX_UARTA_IRQ+7)

#define BCM_LINUX_PERFCOUNT_IRQ		(BCM_LINUX_UARTA_IRQ+8)

#define BCM_LINUX_PATA_IRQ		(BCM_LINUX_UARTA_IRQ+9)
