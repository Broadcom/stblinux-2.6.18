...
#define	ADP_AUDIO_IRQ	0x40000000
#define	BGE_PCM_IRQ		0x20000000
#define	ATPC_IRQ		0x10000000
#define	UART_IRQ		0x08000000
#define BGE_VEC_IRQ		0x04000000
#define ADPC_IRQ		0x02000000
#define RFM_IRQ			0x01000000
#define	ADPA_IRQ		0x00800000
#define	ATPA_IRQ		0x00400000
#define	XPT_ICAM_IRQ	0x00200000
...
#define	BGE_CPU_IRQ		0x00010000
#define MIPS_IRQ		0x00004000
#define	SDS_RX1_IRQ		0x00002000
#define	SDS_MIPS_IRQ	0x00001000
#define	I2C_IRQ			0x00000800
#define	SPI_IRQ			0x00000400
#define	UPG_IRQ			0x00000200
#define	SM_IRQ			0x00000100
#define	DAA_2_IRQ		0x00000080
#define	DAA_1_IRQ		0x00000040
#define	USB_IRQ			0x00000020
#define	MPI_IRQ			0x00000002
