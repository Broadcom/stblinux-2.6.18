...
/* PCI physical memory map */
#define PCI_3560_PHYS_ISB_WIN_BASE    0x10000000
#define PCI_3560_PHYS_MEM_WIN0_BASE   0x00000000
#define PCI_3560_PHYS_MEM_WIN1_BASE   0x02000000
#define PCI_3560_PHYS_MEM_WIN2_BASE   0x04000000

#define PCI_USB_OHCI0_PHYS_MEM_WIN_BASE    0xd0000000

#define PCI_USB_OHCI1_PHYS_MEM_WIN_BASE    0xd0001000

#define PCI_USB_EHCI_PHYS_MEM_WIN_BASE    0xd0002000


#define PCI_1394_PHYS_MEM_WIN0_BASE   0xd0010000

#define PCI_DEVICE_ID_EXT       0x0c
#define PCI_DEVICE_ID_USB       0x0d
#define PCI_DEVICE_ID_1394      0x0e

#define PCI_IDSEL_EXT           (0x10000 << PCI_DEVICE_ID_EXT)
#define PCI_IDSEL_USB           (0x10000 << PCI_DEVICE_ID_USB)
#define PCI_IDSEL_1394          (0x10000 << PCI_DEVICE_ID_1394)

#define PCI_DEV_NUM_EXT         (PCI_DEVICE_ID_EXT  << 11)
#define PCI_DEV_NUM_USB         (PCI_DEVICE_ID_USB << 11)
