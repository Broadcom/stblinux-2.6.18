...
#define UPG_SCB_BASE		(UPG_ADR_BASE+0x0070)    /* smart card B registers */
#define UPG_GIOEXT_BASE		(UPG_ADR_BASE+0x00a0)    /* gpio extended registers */
...
#define UART_RXDATA     	0x01
#define UART_CONTROL    	0x03
#define UART_BAUDHI     	0x04
#define UART_BAUDLO     	0x05
#define UART_TXSTAT     	0x06
#define UART_TXDATA     	0x07

/* UART registers, redefined to please brcmserial.c */
#define UARTA_RXSTAT     	UART_RXSTAT
#define UARTA_RXDATA     	UART_RXDATA
#define UARTA_CONTROL    UART_CONTROL
#define UARTA_BAUDHI     	UART_BAUDHI
#define UARTA_BAUDLO     	UART_BAUDLO
#define UARTA_TXSTAT     	UART_TXSTAT
#define UARTA_TXDATA     	UART_TXDATA
...
#define PM1_CONFIG_I2C_SEL			0x04
#define PM1_CONFIG_UARTA_IRQEN_SEL	0x10
#define PM1_CONFIG_SC_EXT_CLK_SEL	0x40
...
/* These GIOEXT registers are offsets from GPIO base.  
   This allows us to use the GPIO device to access these 
   registers without having to create another device. */   
#define REG_UPG_GIOEXT_OUTLSB  ( 0x51 )
#define REG_UPG_GIOEXT_DIRLSB  ( 0x53 )
#define REG_UPG_GIOEXT_ODLSB   ( 0x55 )
#define REG_UPG_GIOEXT_ECLSB   ( 0x57 )
#define REG_UPG_GIOEXT_EILSB   ( 0x59 )
#define REG_UPG_GIOEXT_MASKLSB ( 0x5B )
#define REG_UPG_GIOEXT_RSTLSB  ( 0x5D )
#define REG_UPG_GIOEXT_STATLSB ( 0x5F )
...
#define UPG_IRR_IRQ			0x01	/* Keyboard/remote receiver */
#define UPG_RESERVED2_IRQ	0x02	/* not used */
#define UPG_IRB_IRQ			0x04	/* Infrared Blaster */
#define UPG_UB_IRQ			0x08	/* UART B */
#define UPG_UA_IRQ			0x10	/* UART A */
#define UPG_RESERVED1_IRQ	0x20	/* not used */
...
#define	UPG_IRQ_HI_ALL		0x0F	/* all interrupts at IRQ_HI */
...
#define	REG_UPG_KBD_TIMEOUT		(0x0c)
#define	REG_UPG_KBD_SWITCH_CONFIG	(0x0d)
#define	REG_UPG_KBD_SWITCH_STATUS	(0x0e)
...
/*
 * Definitions for KBD_SWITCH_CONFIG register
 */
#define KBD_SWITCH_CONFIG_IRSEL				0x04
#define KBD_SWITCH_CONFIG_IRSEL_OVERRIDE	0x02
#define KBD_SWITCH_CONFIG_TIMEOUT_MODE		0x01

/*
 * Definitions for KBD_SWITCH_STATUS register
 */
#define KBD_SWITCH_STATUS_IR2			0x02
#define KBD_SWITCH_STATUS_IR1			0x01
...
/****************************************************************
 * Upg ICAP relative offsets.
 ****************************************************************/
#define REG_UPG_ICAP_INEDGE			0x00
#define REG_UPG_ICAP_RCNT0			0x01
#define REG_UPG_ICAP_RCNT1			0x02
#define REG_UPG_ICAP_RCNT2			0x03
#define REG_UPG_ICAP_MASK			0x04
#define REG_UPG_ICAP_TCNT0MSB		0x05
#define REG_UPG_ICAP_TCNT0LSB		0x06
#define REG_UPG_ICAP_TCNT1MSB		0x07
#define REG_UPG_ICAP_TCNT1LSB		0x08
#define REG_UPG_ICAP_TCNT2MSB		0x09
#define REG_UPG_ICAP_TCNT2LSB		0x0A
#define REG_UPG_ICAP_RCNT3			0x0B
#define REG_UPG_ICAP_TCNT3MSB		0x0C
#define REG_UPG_ICAP_TCNT3LSB		0x0D
#define REG_UPG_ICAP_RST			0x0E
#define REG_UPG_ICAP_INSTATUS		0x0F

#define ICAP_INEDGE_POS_SHIFTS		4

#define ICAP_PIN_MAX				3	/* 0-3 */

#define ICAP_RCNT_MAX				0x0F
