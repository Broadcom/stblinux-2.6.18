...
#
# CONFIG_LIB_DIRECTFB_FORCE is not set
...
# CONFIG_LIB_LIBSTDCXX_FORCE is not set
# CONFIG_LIB_LIBSUPCXX_FORCE is not set
# CONFIG_LIB_LIBGCC_FORCE is not set
...
CONFIG_USER_MTDUTILS_NANDDUMP=y
CONFIG_USER_MTDUTILS_NANDTEST=y
CONFIG_USER_MTDUTILS_NANDWRITE=y
...
CONFIG_USER_E2FSPROGS_MISC_BADBLOCKS=y
...
CONFIG_USER_E2FSPROGS_MISC_MKLOST_FOUND=y
...
# CRAMFS
#
CONFIG_USER_CRAMFS_CRAMFSCK=y
CONFIG_USER_CRAMFS_MKCRAMFS=y
CONFIG_LIB_ZLIB=y

#
# SQUASHFS
#
CONFIG_USER_SQUASHFS_MKSQUASHFS=y
# CONFIG_USER_SQUASHFS_UNSQUASHFS is not set

#
# XFS
#
# CONFIG_USER_XFS_XFSPROGS is not set
# CONFIG_USER_XFS_TEST_SUITE is not set

#
# Network Applications
#
CONFIG_USER_ROUTE_ARP=y
...
# CONFIG_USER_DHCPCV6_DHCPCV6 is not set
# CONFIG_USER_DHCPSV6_DHCPSV6 is not set
...
# CONFIG_USER_EPI_TTCP is not set
...
# CONFIG_USER_BRCM_MOCA is not set
...
# Wireless-support
#
# CONFIG_USER_WIRELESS_SUPPORT is not set
...
# CONFIG_USER_AFFINITY is not set
# CONFIG_USER_BONNIEXX_BONNIEXX is not set
# CONFIG_USER_CAL_CAL is not set
# CONFIG_USER_CHAT_AFFINITY is not set
...
# CONFIG_USER_DMALLOC_DMALLOC is not set
# CONFIG_USER_TRIPWIRE_TRIPWIRE is not set
# CONFIG_USER_QUOTA_TOOLS is not set
...
# CONFIG_USER_PROFILE_OPROFILE is not set
# CONFIG_USER_PROFILE_POFT is not set

#
# Debug tools
#
# CONFIG_USER_TIMEPEG_TPT is not set
# CONFIG_USER_LTT_TRACEDAEMON is not set
