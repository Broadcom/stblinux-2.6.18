...
M::enum return_value_convention:return_value:struct value *function, struct regcache *regcache, gdb_byte *readbuf, const gdb_byte *writebuf:function, regcache, readbuf, writebuf::legacy_return_value
