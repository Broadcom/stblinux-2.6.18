...
int
using_struct_return (struct value *function, int gcc_p)
{
  enum type_code code = TYPE_CODE (value_type (function));
  ...
  return (gdbarch_return_value (current_gdbarch, function,
				NULL, NULL, NULL)
