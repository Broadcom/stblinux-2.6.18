...
do_locals_tests ()
{
  static struct _simple_struct blank_simple;
  int linteger = 0;
  int *lpinteger = NULL;
  char lcharacter = 0;
  ...
  float *lpfloat = NULL;
  double ldouble = 0;
  double *lpdouble = NULL;
  struct _simple_struct lsimple = blank_simple;
  struct _simple_struct *lpsimple = NULL;
  void (*func) (void) = NULL;
...
{
  static struct _struct_decl blank_declarations;
  static struct _struct_n_pointer blank_np;
  weird_struct *weird = NULL;
  struct _struct_n_pointer *psnp = NULL;
  struct _struct_n_pointer snp0 = blank_np, snp1 = blank_np, snp2 = blank_np;
  char a0 = 0, *a1 = NULL, **a2 = NULL, ***a3 = NULL;
  char b0 = 0, *b1 = NULL, **b2 = NULL, ***b3 = NULL;
  char c0 = 0, *c1 = NULL, **c2 = NULL, ***c3 = NULL;
  long z0 = 0, *z1 = NULL, **z2 = NULL, ***z3 = NULL;
  long y0 = 0, *y1 = NULL, **y2 = NULL, ***y3 = NULL;
  long x0 = 0, *x1 = NULL, **x2 = NULL, ***x3 = NULL;
  int *foo = NULL;
  int bar = 0;

  struct _struct_decl struct_declarations = blank_declarations;
